...
pub struct State {
    ...
    pub three_unanswered_tries_team: String,
...
impl State {
    pub fn new(
        ...
        three_unanswered_tries_team: String,
        time_elapsed: i32,
...
pub fn anytime_output_event(state: &State) -> bool {
...
pub fn end_of_game_output_event(state: &State) -> bool {
    ...
    if _cse_temp_1 {
        ...
        let _cse_temp_2 = home_second_half_stats.as_ref().unwrap().scores.total
            + home_extra_time_stats.as_ref().unwrap().scores.total;
        home_second_half_with_et = _cse_temp_2;
        away_second_half_with_et = _cse_temp_2;
        ...
        let _cse_temp_4 = home_second_half_with_et > away_second_half_with_et;
        team_a_won_second_half_and_et = _cse_temp_4;
        let _cse_temp_5 = state.home_match_score == state.away_match_score;
        draw_match = _cse_temp_5;
        let _cse_temp_6 = state.home_match_score > state.away_match_score;
        team_a_won_match = _cse_temp_6;
        let team_b_won_match = _cse_temp_6;
...
pub fn first_half_output_event(state: &State) -> bool {
    let mut away_first_half_stats: Option<Statistics> = None;
    ...
    if _cse_temp_1 {
        ...
        let _cse_temp_3 = away_first_half_total > home_first_half_total;
        team_b_won_first_half = _cse_temp_3;
        let _cse_temp_4 = home_first_half_total == away_first_half_total;
        draw_first_half = _cse_temp_4;
...
pub fn normal_time_output_event(state: &State) -> bool {
    let mut away_first_half_stats: Option<Statistics> = None;
    ...
    if _cse_temp_0 {
        ...
        let _cse_temp_1 = away_first_half_stats.as_ref().unwrap().scores.total
...
pub fn player_void_output_event(state: &State) -> bool {
...
pub fn period_first_last_score_helper(state: &State) -> bool {
...
pub fn first_to_score_tracking_event(state: &State) -> bool {
    ...
    if _cse_temp_2 {
        ...
        extra_time_first_score_incident = points_confirmed_incidents
            ...
            .map(|incident| incident)
            .next();
        last_score_incident = if !points_confirmed_incidents.clone().is_empty() {
...
pub fn minute_winner_tracking_event(state: &State) -> bool {
...
pub fn player_score_tracking_event(state: &State) -> bool {
    ...
    if state.include_players {
        ...
        let _cse_temp_0 = try_scorer_indices.clone().len() as i32;
        let _cse_temp_1 = _cse_temp_0 > 0;
        if _cse_temp_1 {
            record_int("FirstTryScorerJerseyMatch".to_string(), first_try_jersey);
        }
        let _cse_temp_2 = home_try_scorer_indices.clone().len() as i32;
        ...
        let _cse_temp_4 = away_try_scorer_indices.clone().len() as i32;
        ...
        let _cse_temp_6 = state.three_unanswered_tries_team.clone() != "NotSet";
        if _cse_temp_6 {
            record_bool("ThreeUnansweredTries".to_string(), true);
        }
        let _cse_temp_7 = (state.is_over) && (_cse_temp_1);
        if _cse_temp_7 {
...
pub fn race_to_points_tracking_event(state: &State) -> bool {
...
pub fn update_game_status(state: &mut State) -> bool {
    if true {
...
pub fn field_goal_attempt(state: &mut State) -> FieldGoalAttemptOutputs {
...
pub fn field_goal_decision(state: &mut State) -> FieldGoalDecisionOutputs {
    ...
    in_time = _cse_temp_4;
    let _cse_temp_5 = state.team_in_possession.clone() == "Away";
    let _cse_temp_6 = state.ball_location.x < FIELD_GOAL_MIN_AWAY;
    let _cse_temp_7 = (_cse_temp_5) && (_cse_temp_6);
    let _cse_temp_8 = state.team_in_possession.clone() == "Home";
    let _cse_temp_9 = state.ball_location.x > FIELD_GOAL_MIN_HOME;
    let _cse_temp_10 = (_cse_temp_8) && (_cse_temp_9);
    let _cse_temp_11 = (_cse_temp_7) || (_cse_temp_10);
    in_direction = _cse_temp_11;
    let _cse_temp_12 = state.ball_location.x > FIELD_GOAL_MIN_ABSOLUTE;
    let _cse_temp_13 = state.ball_location.x < FIELD_GOAL_MAX_ABSOLUTE;
    let _cse_temp_14 = (_cse_temp_12) && (_cse_temp_13);
    in_bounds = _cse_temp_14;
    execute_events(state);
    return FieldGoalDecisionOutputs::new(((in_bounds) && (in_time)) && (in_direction));
}
pub fn get_conversion_model_result(state: &mut State) -> GetConversionModelResultOutputs {
    let mut conversion_k: f64 = 0.0;
    let mut is_extra_time: bool = false;
    let mut player_advantage: i32 = 0;
    let _cse_temp_0 = state.period.name.clone() == "ExtraTime";
...
pub fn get_field_goal_model_result(state: &mut State) -> GetFieldGoalModelResultOutputs {
...
pub fn get_kickoff_model_result(state: &mut State) -> GetKickoffModelResultOutputs {
...
pub fn next_play(state: &mut State) -> NextPlayOutputs {
...
pub fn penalty_type(state: &mut State) -> PenaltyTypeOutputs {
...
pub fn player_interchange(state: &mut State, team: String) -> PlayerInterchangeOutputs {
...
pub fn player_meters(state: &mut State) -> PlayerMetersOutputs {
...
pub fn player_sin_bin(state: &mut State, sin_bin_team_is_home: bool) {
    ...
    let model: PlayerSinBinInferOutputs0 = infer::<PlayerSinBinInferOutputs0>(
        ...
        vec![
            ...
            (state.simulation_invariants.total_points) as f64,
            (state.clone().home_match_score + state.clone().away_match_score) as f64,
...
pub fn player_tries(state: &mut State, team: String) -> PlayerTriesOutputs {
...
pub fn sin_bin(state: &mut State) -> SinBinOutputs {
...
pub fn xy(state: &mut State) -> XyOutputs {
    let mut is_extra_time: bool = false;
    let mut player_advantage: i32 = 0;
    let _cse_temp_0 = state.period.name.clone() == "ExtraTime";
    is_extra_time = _cse_temp_0;
...
pub fn execute_events(state: &mut State) {
    let _cse_temp_0 = !state
        .clone()
        .executed_events
        .clone()
        .contains("period_first_last_score_helper");
    if _cse_temp_0 {
        let mut success = period_first_last_score_helper(state);
        if success {
            state
                .executed_events
                .insert("period_first_last_score_helper".to_string());
        }
    }
    let _cse_temp_1 = !state
        .clone()
        .executed_events
        .clone()
        .contains("first_half_output_event");
    if _cse_temp_1 {
        let mut success = first_half_output_event(state);
        if success {
            state
                .executed_events
                .insert("first_half_output_event".to_string());
        }
    }
    let _cse_temp_2 = !state
        .clone()
        .executed_events
        .clone()
        .contains("normal_time_output_event");
    if _cse_temp_2 {
        let mut success = normal_time_output_event(state);
        if success {
            state
                .executed_events
                .insert("normal_time_output_event".to_string());
        }
    }
    let _cse_temp_3 = !state
        .clone()
        .executed_events
        .clone()
        .contains("player_score_tracking_event");
    if _cse_temp_3 {
        let mut success = player_score_tracking_event(state);
        if success {
            state
                .executed_events
                .insert("player_score_tracking_event".to_string());
        }
    }
    let _cse_temp_4 = !state
        .clone()
        .executed_events
        .clone()
        .contains("minute_winner_tracking_event");
    if _cse_temp_4 {
        let mut success = minute_winner_tracking_event(state);
        if success {
            state
                .executed_events
                .insert("minute_winner_tracking_event".to_string());
        }
    }
    let _cse_temp_5 = !state
        .executed_events
        .clone()
        .contains("player_void_output_event");
    if _cse_temp_5 {
        let mut success = player_void_output_event(state);
        if success {
            state
                .executed_events
                .insert("player_void_output_event".to_string());
        }
    }
    let _cse_temp_6 = !state
        .executed_events
        .clone()
        .contains("end_of_game_output_event");
    if _cse_temp_6 {
        let mut success = end_of_game_output_event(state);
        if success {
            state
                .executed_events
                .insert("end_of_game_output_event".to_string());
        }
    }
    update_game_status(state);
    let _cse_temp_7 = !state
        .executed_events
        .clone()
        .contains("first_to_score_tracking_event");
    if _cse_temp_7 {
        let mut success = first_to_score_tracking_event(state);
        if success {
            state
                .executed_events
                .insert("first_to_score_tracking_event".to_string());
        }
    }
    let _cse_temp_8 = !state
        .executed_events
        .clone()
        .contains("race_to_points_tracking_event");
    if _cse_temp_8 {
        let mut success = race_to_points_tracking_event(state);
        if success {
            state
                .executed_events
                .insert("race_to_points_tracking_event".to_string());
        }
    }
    let _cse_temp_9 = !state
        .executed_events
        .clone()
        .contains("anytime_output_event");
    if _cse_temp_9 {
        let mut success = anytime_output_event(state);
        if success {
            state
                .executed_events
                .insert("anytime_output_event".to_string());
        }
    }
}
#[cfg(test)]
mod tests {
    ...
    #[test]
    fn test_update_game_status_examples() {
        let _ = update_game_status(Default::default());
    }
    #[test]
