//! Const-generic array size inference.
//!
//! Provides [`ConstGenericInferencer`] for detecting fixed-size array patterns
//! in Python code and inferring Rust const-generic array sizes.
//!
//! Generic type-parameter inference (formerly in this file) has been split into
//! the [`generic_inference`] submodule and is re-exported below.

pub use crate::types::generic_inference::{
    GenericType, TypeBound, TypeParameter, TypeVarConstraints, TypeVarRegistry, Variance,
};
