...
#[test]
fn test_conservative_string_borrowed() {
    let mapper = AnnotationAwareTypeMapper::new();
...
#[test]
fn test_conservative_string_owned() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations {
        string_strategy: StringStrategy::Conservative,
...
#[test]
fn test_conservative_string_shared() {
    let mapper = AnnotationAwareTypeMapper::new();
...
#[test]
fn test_list_shared_with_thread_safety() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations {
...
#[test]
fn test_dict_shared_not_thread_safe() {
    let mapper = AnnotationAwareTypeMapper::new();
    let mut annotations = TranspilationAnnotations::default();
    annotations.ownership_model = OwnershipModel::Shared;
    annotations.thread_safety = ThreadSafety::NotRequired;
...
#[test]
fn test_return_type_none_default_strategy() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations::default();
...
#[test]
fn test_return_type_none_result_strategy() {
    let mapper = AnnotationAwareTypeMapper::new();
    let mut annotations = TranspilationAnnotations::default();
...
#[test]
fn test_base_mapper_fallback_int() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations::default();
...
#[test]
fn test_base_mapper_fallback_float() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations::default();
...
#[test]
fn test_base_mapper_fallback_bool() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations::default();
...
#[test]
fn test_base_mapper_fallback_none() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations::default();
...
#[test]
fn test_base_mapper_fallback_custom() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations::default();
...
#[test]
fn test_zero_copy_borrowed_list() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations {
...
#[test]
fn test_result_type_optional_string() {
    let mapper = AnnotationAwareTypeMapper::new();
    let mut annotations = TranspilationAnnotations::default();
    annotations.error_strategy = ErrorStrategy::ResultType;
...
#[test]
fn test_shared_thread_safe_nested_dict() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations {
        ownership_model: OwnershipModel::Shared,
        thread_safety: ThreadSafety::Required,
...
#[test]
fn test_mixed_ownership_annotations() {
    let mapper = AnnotationAwareTypeMapper::new();
...
#[test]
fn test_integration_api_response_type() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations {
        ownership_model: OwnershipModel::Owned,
...
#[test]
fn test_integration_zero_copy_parser() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations {
        string_strategy: StringStrategy::ZeroCopy,
        ownership_model: OwnershipModel::Borrowed,
...
#[test]
fn test_integration_thread_safe_cache() {
    let mapper = AnnotationAwareTypeMapper::new();
    let annotations = TranspilationAnnotations {
        ownership_model: OwnershipModel::Shared,
        thread_safety: ThreadSafety::Required,
