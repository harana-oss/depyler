...
impl TranspilationTestHarness {
    ...
    /// Transpile Python code and return the resulting Rust code
    pub fn transpile(&self, python_source: &str) -> String {
        self.pipeline.transpile(python_source).expect("Transpilation failed")
    }
...
"#;
        ...
        let result = harness.transpile(python_code);
