...
"#;
    ...
    let rust_code = transpile(py_code);
...
"#;
    ...
    assert!(rust_code.contains("(2 as f64).powf(-1 as f64)") || rust_code.contains("(2 as f64).powf(- 1 as f64)"));
    assert!(rust_code.contains("(10 as f64).powf(-2 as f64)") || rust_code.contains("(10 as f64).powf(- 2 as f64)"));
}
