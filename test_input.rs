...
lazy_static! {
    pub static ref CONVERSION_X_VALUES: Vec<i32> = vec![
        769, 773, 779, 788, 801, 823, 845, 866, 878, 890, 890, 882, 868, 847, 825, 801, 786, 779, 771, 769
    ];
    ...
    pub static ref Y_VALUES: Vec<(i32, i32)> =
        vec![(0, 118), (118, 234), (234, 351), (351, 468), (468, 584), (584, 700)];
    pub static ref Y_VALUES_AWAY: Vec<(i32, i32)> =
        vec![(584, 700), (468, 584), (351, 468), (234, 351), (118, 234), (0, 118)];
}
...
impl State {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            ...
            "away_match_score" => Some(Box::new(self.away_match_score.clone()) as Box<dyn std::any::Any>),
            "away_period_try_scorers" => Some(Box::new(self.away_period_try_scorers.clone()) as Box<dyn std::any::Any>),
            "away_player_selected_for_points_market" => {
                Some(Box::new(self.away_player_selected_for_points_market.clone()) as Box<dyn std::any::Any>)
            }
            "away_players_trader_state" => {
            ...
            "away_statistics" => Some(Box::new(self.away_statistics.clone()) as Box<dyn std::any::Any>),
            "away_total_try_scorers" => Some(Box::new(self.away_total_try_scorers.clone()) as Box<dyn std::any::Any>),
            "ball_location" => Some(Box::new(self.ball_location.clone()) as Box<dyn std::any::Any>),
            "current_play_type" => Some(Box::new(self.current_play_type.clone()) as Box<dyn std::any::Any>),
            ...
            "home_match_score" => Some(Box::new(self.home_match_score.clone()) as Box<dyn std::any::Any>),
            "home_period_try_scorers" => Some(Box::new(self.home_period_try_scorers.clone()) as Box<dyn std::any::Any>),
            "home_player_selected_for_points_market" => {
                Some(Box::new(self.home_player_selected_for_points_market.clone()) as Box<dyn std::any::Any>)
            }
            "home_players_trader_state" => {
            ...
            "home_statistics" => Some(Box::new(self.home_statistics.clone()) as Box<dyn std::any::Any>),
            "home_total_try_scorers" => Some(Box::new(self.home_total_try_scorers.clone()) as Box<dyn std::any::Any>),
            "incidents" => Some(Box::new(self.incidents.clone()) as Box<dyn std::any::Any>),
            "include_players" => Some(Box::new(self.include_players.clone()) as Box<dyn std::any::Any>),
            "is_in_end_zone" => Some(Box::new(self.is_in_end_zone.clone()) as Box<dyn std::any::Any>),
            "is_over" => Some(Box::new(self.is_over.clone()) as Box<dyn std::any::Any>),
            "last_play_type" => Some(Box::new(self.last_play_type.clone()) as Box<dyn std::any::Any>),
            "period_try_scorers" => Some(Box::new(self.period_try_scorers.clone()) as Box<dyn std::any::Any>),
            "period" => Some(Box::new(self.period.clone()) as Box<dyn std::any::Any>),
            "player_of_the_match" => Some(Box::new(self.player_of_the_match.clone()) as Box<dyn std::any::Any>),
            "previous_ball_location" => Some(Box::new(self.previous_ball_location.clone()) as Box<dyn std::any::Any>),
            "previous_play_type" => Some(Box::new(self.previous_play_type.clone()) as Box<dyn std::any::Any>),
            "set" => Some(Box::new(self.set.clone()) as Box<dyn std::any::Any>),
            "simulation_invariants" => Some(Box::new(self.simulation_invariants.clone()) as Box<dyn std::any::Any>),
            ...
            "total_match_score" => Some(Box::new(self.total_match_score.clone()) as Box<dyn std::any::Any>),
            "total_period" => Some(Box::new(self.total_period.clone()) as Box<dyn std::any::Any>),
            "total_try_scorers" => Some(Box::new(self.total_try_scorers.clone()) as Box<dyn std::any::Any>),
            _ => None,
        }
    }
...
impl Incident {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "has_points_confirmed" => Some(Box::new(self.has_points_confirmed.clone()) as Box<dyn std::any::Any>),
            "has_points_scored" => Some(Box::new(self.has_points_scored.clone()) as Box<dyn std::any::Any>),
            "period" => Some(Box::new(self.period.clone()) as Box<dyn std::any::Any>),
            "points_confirmed_player_index" => {
            ...
            "points_scored_points" => Some(Box::new(self.points_scored_points.clone()) as Box<dyn std::any::Any>),
            "points_scored_score_id" => Some(Box::new(self.points_scored_score_id.clone()) as Box<dyn std::any::Any>),
            "points_scored_score_type" => {
                Some(Box::new(self.points_scored_score_type.clone()) as Box<dyn std::any::Any>)
            }
            "points_scored_team" => Some(Box::new(self.points_scored_team.clone()) as Box<dyn std::any::Any>),
            "time_elapsed" => Some(Box::new(self.time_elapsed.clone()) as Box<dyn std::any::Any>),
            _ => None,
        }
    }
...
impl Player {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "delta_strength" => Some(Box::new(self.delta_strength.clone()) as Box<dyn std::any::Any>),
            "expected_tries_per_min" => Some(Box::new(self.expected_tries_per_min.clone()) as Box<dyn std::any::Any>),
            ...
            "is_interchange" => Some(Box::new(self.is_interchange.clone()) as Box<dyn std::any::Any>),
            ...
            "period_statistics" => Some(Box::new(self.period_statistics.clone()) as Box<dyn std::any::Any>),
            ...
            "sin_bin_sent_off" => Some(Box::new(self.sin_bin_sent_off.clone()) as Box<dyn std::any::Any>),
            "sin_bin_status" => Some(Box::new(self.sin_bin_status.clone()) as Box<dyn std::any::Any>),
            "total_statistics" => Some(Box::new(self.total_statistics.clone()) as Box<dyn std::any::Any>),
            "total_strength" => Some(Box::new(self.total_strength.clone()) as Box<dyn std::any::Any>),
            "tries_per_minute_in_use" => Some(Box::new(self.tries_per_minute_in_use.clone()) as Box<dyn std::any::Any>),
            "tries_per_minute" => Some(Box::new(self.tries_per_minute.clone()) as Box<dyn std::any::Any>),
            "tries_percentage_in_use" => Some(Box::new(self.tries_percentage_in_use.clone()) as Box<dyn std::any::Any>),
            "tries_percentage" => Some(Box::new(self.tries_percentage.clone()) as Box<dyn std::any::Any>),
            "tries_strength" => Some(Box::new(self.tries_strength.clone()) as Box<dyn std::any::Any>),
            _ => None,
        }
    }
    pub fn _set_field(&mut self, name: &str, value: &dyn std::any::Any) -> bool {
...
impl Statistics {
    pub fn new(conversions_missed: i32, penalties_awarded: i32, scores: Scores, tackles: i32, turnovers: i32) -> Self {
        Self {
            conversions_missed,
            penalties_awarded,
            scores,
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "conversions_missed" => Some(Box::new(self.conversions_missed.clone()) as Box<dyn std::any::Any>),
            "penalties_awarded" => Some(Box::new(self.penalties_awarded.clone()) as Box<dyn std::any::Any>),
            "scores" => Some(Box::new(self.scores.clone()) as Box<dyn std::any::Any>),
            "tackles" => Some(Box::new(self.tackles.clone()) as Box<dyn std::any::Any>),
...
impl TeamStatistics {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "period_statistics" => Some(Box::new(self.period_statistics.clone()) as Box<dyn std::any::Any>),
            "player_statistics" => Some(Box::new(self.player_statistics.clone()) as Box<dyn std::any::Any>),
            "sin_bin_players" => Some(Box::new(self.sin_bin_players.clone()) as Box<dyn std::any::Any>),
            "total_statistics" => Some(Box::new(self.total_statistics.clone()) as Box<dyn std::any::Any>),
            _ => None,
        }
    }
...
impl PlayerInvariants {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "player_solution" => Some(Box::new(self.player_solution.clone()) as Box<dyn std::any::Any>),
            "player_trader_state" => Some(Box::new(self.player_trader_state.clone()) as Box<dyn std::any::Any>),
            _ => None,
        }
    }
    pub fn _set_field(&mut self, name: &str, value: &dyn std::any::Any) -> bool {
...
impl PlayerSolution {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            ...
            "solved_expected_tries_percentage" => {
                Some(Box::new(self.solved_expected_tries_percentage.clone()) as Box<dyn std::any::Any>)
            }
            _ => None,
        }
    }
...
impl SimulationInvariants {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "all_players_invariants" => Some(Box::new(self.all_players_invariants.clone()) as Box<dyn std::any::Any>),
...
impl ClockOutputs {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "seconds_to_add" => Some(Box::new(self.seconds_to_add.clone()) as Box<dyn std::any::Any>),
            _ => None,
        }
    }
    pub fn _set_field(&mut self, name: &str, value: &dyn std::any::Any) -> bool {
...
impl GetKickoffModelResultOutputs {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "change_possession" => Some(Box::new(self.change_possession.clone()) as Box<dyn std::any::Any>),
...
impl PlayerInterchangeOutputs {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            ...
            "off_player_index" => Some(Box::new(self.off_player_index.clone()) as Box<dyn std::any::Any>),
            "on_player_index" => Some(Box::new(self.on_player_index.clone()) as Box<dyn std::any::Any>),
...
impl XyOutputs {
    ...
    pub fn _get_field(&self, name: &str) -> Option<Box<dyn std::any::Any>> {
        match name {
            "field_position" => Some(Box::new(self.field_position.clone()) as Box<dyn std::any::Any>),
            _ => None,
        }
    }
    pub fn _set_field(&mut self, name: &str, value: &dyn std::any::Any) -> bool {
...
pub fn anytime_output_event(state: &State) {
    ...
    if false {
        println!("{}", "[Anytime Output Event] Get period and match statistics");
...
pub fn end_of_game_output_event(state: &State) {
    ...
    if _cse_temp_0 {
        ...
        draw_match = _cse_temp_4;
        let _cse_temp_5 = state.home_match_score > state.away_match_score;
        team_a_won_match = _cse_temp_5;
        let team_b_won_match = _cse_temp_5;
        ...
        record_bool("WinHalf2AndExtraTimeA".to_string(), team_a_won_second_half_and_et);
        record_bool("WinHalf2AndExtraTimeB".to_string(), team_b_won_second_half_and_et);
...
pub fn first_half_output_event(state: &State) {
    ...
    if false {
        println!("{}", "[First Half Output Event] Get first half period statistics");
        away_first_half_stats = Some(
            state
                .away_statistics
                .period_statistics
        ...
        println!("{}", "[First Half Output Event] Calculate first half scores");
        ...
        println!("{}", "[First Half Output Event] Determine first half results");
        let _cse_temp_0 = home_first_half_total == away_first_half_total;
        draw_first_half = _cse_temp_0;
        ...
        team_a_won_first_half = _cse_temp_2;
        ...
        println!("{}", "[First Half Output Event] Output first half win/draw results");
...
pub fn normal_time_output_event(state: &State) {
    ...
    if false {
        ...
        println!("{}", "[Normal Time Output Event] Calculate normal time scores");
        ...
        println!("{}", "[Normal Time Output Event] Determine extra time occurrence");
        let _cse_temp_1 = home_normal_time_score == away_normal_time_score;
        extra_time_occurred = _cse_temp_1;
        println!("{}", "[Normal Time Output Event] Output normal time results");
...
pub fn player_void_output_event(state: &State) {
    ...
    if true {
        ...
        println!("{}", "[Player Void Output Event] Output home player void status");
        for player in home_trader_players.iter().cloned() {
            println!("{}", "[Player Void Output Event] record");
            record_bool(format!("Player_Voided_{}", player.player_index), player.is_voided);
        }
        println!("{}", "[Player Void Output Event] Output away player void status");
...
pub fn period_first_last_score_helper(state: &State) {
    ...
    if false {
        println!("{}", "[Period First Last Score Helper] Find first try in period");
        first_try_team = state
            ...
            .into_iter()
            .filter(|incident| {
                period_filter && incident.has_points_confirmed && incident.points_confirmed_score_type == "Try"
            })
            ...
            .unwrap()
            .points_scored_team;
        println!("{}", "[Period First Last Score Helper] Find first score in period");
        first_score_team = state
            ...
            .unwrap()
            .points_scored_team;
        println!("{}", "[Period First Last Score Helper] Calculate first try times");
        let _cse_temp_0 = {
            let a = state
                .incidents
                .clone()
        ...
        println!("{}", "[Period First Last Score Helper] Output first try results");
        record_bool(
        ...
        println!("{}", "[Period First Last Score Helper] Output first to score results");
        record_bool(
        ...
        println!("{}", "[Period First Last Score Helper] Output first try time results");
...
pub fn first_to_score_tracking_event(state: &State) {
    ...
    if _cse_temp_2 {
        ...
        points_confirmed_incidents = state
            ...
            .into_iter()
            .filter(|incident| {
                incident.has_points_confirmed && ["Home", "Away"].contains(&incident.points_scored_team.as_str())
            })
            .map(|incident| incident)
            .collect::<Vec<_>>();
        println!("{}", "[First To Score Tracking Event] Collect confirmed try incidents");
        ...
        match_first_score_incident = if !points_confirmed_incidents.clone().is_empty() {
            Some(points_confirmed_incidents.clone().get(0usize).cloned().unwrap())
        } else {
            None
        };
...
pub fn minute_winner_tracking_event(state: &State) {
    ...
    let _cse_temp_2 = (_cse_temp_1) || (state.is_over);
    if _cse_temp_2 {
        println!("{}", "[Minute Winner Tracking Event] Initialize interval context");
        ...
        for minute in minute_intervals.iter().cloned() {
            ...
            if final_minute > minute {
                println!("{}", "[Minute Winner Tracking Event] Calculate scores through interval");
                ...
                let home_points_at_minute = state
                    ...
                    .map(|incident| incident.points_scored_points)
                    .sum::<i32>();
                println!("{}", "[Minute Winner Tracking Event] Output minute winner results");
                record_bool(
...
pub fn player_score_tracking_event(state: &State) {
    ...
    let _cse_temp_1 = _cse_temp_0 > 0;
    if _cse_temp_1 {
        println!("{}", "[Player Score Tracking Event] Collect try scorer information");
        ...
        try_scorer_indices = state
            ...
            .clone()
            .into_iter()
            .filter(|incident| incident.has_points_confirmed && incident.points_confirmed_score_type == "Try")
            .map(|incident| incident.points_confirmed_player_index)
            .collect::<Vec<_>>();
        try_teams = state
            .incidents
        ...
        home_first_try_jersey = {
            ...
            let idx: i32 = home_try_scorer_indices.clone().get(0usize).cloned().unwrap();
        ...
        away_first_try_jersey = {
            ...
            let idx: i32 = away_try_scorer_indices.clone().get(0usize).cloned().unwrap();
            let actual_idx = if idx < 0 {
                base.len().saturating_sub(idx.abs() as usize)
            } else {
                idx as usize
        ...
        println!("{}", "[Player Score Tracking Event] Output try team sequence");
        ...
        println!("{}", "[Player Score Tracking Event] Output home team first try scorer");
        record_int(
            "HomeFirstTryScorerMatch".to_string(),
            home_try_scorer_indices.clone().get(0usize).cloned().unwrap(),
        );
        record_int("HomeFirstTryScorerJerseyMatch".to_string(), home_first_try_jersey);
        println!("{}", "[Player Score Tracking Event] Output away team first try scorer");
        record_int(
            "AwayFirstTryScorerMatch".to_string(),
            away_try_scorer_indices.clone().get(0usize).cloned().unwrap(),
        );
        record_int("AwayFirstTryScorerJerseyMatch".to_string(), away_first_try_jersey);
        println!("{}", "[Player Score Tracking Event] Output three unanswered tries");
...
pub fn race_to_points_tracking_event(state: &State) {
    ...
    let _cse_temp_2 = (_cse_temp_1) || (state.is_over);
    if _cse_temp_2 {
        println!("{}", "[Race To Points Tracking Event] Initialize race to context");
        ...
        for incident in &state.incidents {
            ...
            if ((incident.has_points_confirmed) && (["Home", "Away"].contains(&incident.points_scored_team.as_str())))
                && (target_index < race_to_targets.clone().len() as i32)
            {
                ...
                println!("{}", "[Race To Points Tracking Event] Set current race target");
                let current_target = race_to_targets.clone().get(target_index as usize).cloned().unwrap();
                println!("{}", "[Race To Points Tracking Event] Check target completion");
                let home_reached_target = home_running_score >= current_target;
                let away_reached_target = away_running_score >= current_target;
                println!(
                    "{}",
                    "[Race To Points Tracking Event] Record race winner when exactly one team reaches target"
                );
                if home_reached_target != away_reached_target {
                    println!("{}", "[Race To Points Tracking Event] Record");
                    record_bool(format!("FirstToPoints{}A", current_target), home_reached_target);
                    record_bool(format!("FirstToPoints{}B", current_target), away_reached_target);
                    println!("{}", "[Race To Points Tracking Event] Set variables");
        ...
        println!("{}", "[Race To Points Tracking Event] Record unresolved race targets");
...
pub fn add_conversion(state: &mut State) {
    println!("{}", ">>>>>>>>[Conversion] Adding conversion points to state");
...
pub fn calculate_dist_from_centre(state: &State) -> i32 {
    ...
    if _cse_temp_0 {
        ...
        return ((CENTRE_OF_THE_FIELD_Y - PLAYING_FIELD_HEIGHT - state.ball_location.y).abs()) as i32;
    }
}
...
pub fn _swap_team_statistics(state: &State, team: String, off_slot: i32, bench_slot: i32) {
    let mut stats = _team_statistic(state, team);
    {
        let (_swap_tmp0, _swap_tmp1) = (
            stats
                ...
                .cloned()
                .unwrap(),
            stats.player_statistics.clone().get(off_slot as usize).cloned().unwrap(),
        );
    ...
    {
        let (_swap_tmp0, _swap_tmp1) = (
            stats.sin_bin_players.clone().get(bench_slot as usize).cloned().unwrap(),
            stats.sin_bin_players.clone().get(off_slot as usize).cloned().unwrap(),
        );
...
pub fn _swap_game_statistics(state: &State, team: String, off_slot: i32, bench_slot: i32) {
    ...
    {
        let (_swap_tmp0, _swap_tmp1) = (
            mirrored.player_statistics.get(bench_slot as usize).cloned().unwrap(),
            mirrored.player_statistics.get(off_slot as usize).cloned().unwrap(),
        );
    ...
    {
        let (_swap_tmp0, _swap_tmp1) = (
            mirrored.sin_bin_players.get(bench_slot as usize).cloned().unwrap(),
            mirrored.sin_bin_players.get(off_slot as usize).cloned().unwrap(),
        );
...
pub fn softmax(logits: Vec<f64>) -> Vec<f64> {
    let _cse_temp_0 = logits.clone().iter().fold(f64::NEG_INFINITY, |a, &b| a.max(b));
...
pub fn _calculate_total_factor(strength: String, total_points: i32) -> f64 {
    ...
    if _cse_temp_0 {
        return f64::max(3.0 - (0.175 * (total_points as f64) / 10.0 as f64).exp(), 0.1);
    }
...
pub fn _goal_line_bucket(grid_coordinate: i32, k: f64) -> i32 {
    ...
    let weights = GOAL_LINE_ZONE_WEIGHTS.clone().get(y_band as usize).cloned().unwrap();
...
pub fn compute_conversion_location_from_grid(grid_coordinate: i32, k: f64) -> i32 {
    ...
    if _cse_temp_0 {
        ...
        return CONVERSION_X_VALUES.clone().get(default_band as usize).cloned().unwrap();
    }
    let _cse_temp_3 = {
        let a = bucket;
        let b = 5;
...
#[doc = " Depyler: proven to terminate"]
pub fn convert_field_position(state: &State, coordinate: String, team: String) -> FieldPosition {
    let _cse_temp_0 = KICKOFF_RESULTS
        .clone()
        .iter()
        .position(|x| x == &coordinate.clone())
        .map(|i| i as i32)
        .expect("ValueError: value is not in list")
        % 6;
    let y_position = _cse_temp_0;
    let _cse_temp_1 = {
        let a = KICKOFF_RESULTS
            .clone()
            .iter()
    ...
    if _cse_temp_2 {
        ...
        x_range = X_VALUES_AWAY.clone().get(x_position as usize).cloned().unwrap();
        y_range = Y_VALUES_AWAY.clone().get(y_position as usize).cloned().unwrap();
    }
...
pub fn get_goal_line_coordinate(state: &State) -> i32 {
    let grid_coordinate = derive_grid_coordinate(&state.ball_location.clone(), state.team_in_possession.clone());
...
pub fn _resolve_index(coordinate: i32, ranges: Vec<(i32, i32)>) -> i32 {
    for (index, range_bounds) in ranges.iter().enumerate().map(|(i, x)| (i as i32, x.clone())) {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn _create_player_statistics(player: &Player, include_breakdown: bool) -> PlayerStatistics {
    let period_breakdown = if include_breakdown {
        (0..NUM_PERIODS).map(|_| _create_statistics()).collect::<Vec<_>>()
    } else {
        vec![]
    };
    ...
    for team in ["Home", "Away"] {
        ...
        for mut player in players.iter().cloned() {
            player.period_statistics = (0..NUM_PERIODS)
                .map(|_| _create_player_statistics(&player, false))
                .collect::<Vec<_>>();
            let total_statistics = _create_player_statistics(&player, true);
...
pub fn nrl(state: &mut State) {
    ...
    while true {
        ...
        update_state::<State>(|s| {
            s.previous_ball_location = state.clone().ball_location.clone().clone();
        });
        update_state::<State>(|s| {
            s.previous_play_type = state.clone().current_play_type.clone().clone();
        });
        println!("{}", "[NRL] Evaluate field goal");
        let field_goal_decision: FieldGoalDecisionOutputs = field_goal_decision(&state);
        println!("{}", "[NRL] Run field goal attempt model only if gating passes");
        ...
        if field_goal_attempt_result == 1 {
            ...
            update_state::<State>(|s| {
                s.current_play_type = next_play_result.play_type.clone().to_string();
            });
            ...
            if state.clone().current_play_type.clone() == "LineDropout" {
                ...
                update_state::<State>(|s| {
                    s.ball_location = xy_result.field_position.clone().clone();
                });
                ...
                if state.clone().current_play_type.clone() == "KickRetainTry" {
                    ...
                    if state.clone().current_play_type.clone() == "KickTurnover" {
                        ...
                        if state.clone().current_play_type.clone() == "WonPenalty" {
                            ...
                            if state.current_play_type.clone() == "Run" {
                            } else {
                                if state.current_play_type.clone() == "Pass" {
                                } else {
                                    if state.current_play_type.clone() == "ErrorDefence" {
                                        println!("{}", "[NRL] Set variables");
                                        update_state::<State>(|s| {
                                            s.tackles = STARTING_TACKLE;
                                        });
                                    } else {
                                        if state.current_play_type.clone() == "KickRetainTackle" {
                                            println!("{}", "[NRL] Run process_tackle");
                                            process_tackle(state);
                                        } else {
                                            if state.current_play_type.clone() == "RunTackle" {
                                                println!("{}", "[NRL] Run process_tackle");
                                                process_tackle(state);
                                            } else {
                                                if state.current_play_type.clone() == "ConcededPenalty" {
                                                    println!("{}", "[NRL] Run process_penalty");
                                                    process_penalty(state);
                                                } else {
                                                    if state.current_play_type.clone() == "KickRetain" {
                                                    } else {
                                                        if state.current_play_type.clone() == "RunTry" {
                                                            println!("{}", "[NRL] Run process_try");
                                                            process_try(state);
                                                        } else {
                                                            if state.current_play_type.clone() == "ErrorAttack" {
                                                                println!("{}", "[NRL] Run swap_possession");
                                                                swap_possession(state);
                                                            }
                                                        }
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn check_game_status(state: &State) {
    println!("{}", "[CheckGameStatus] Check if normal time half is complete");
    ...
    if _cse_temp_2 {
        ...
        let _cse_temp_3 = state.period.name.clone() == "FirstHalf";
        if _cse_temp_3 {
            ...
            update_state::<State>(|s| {
                s.period.name = "SecondHalf".to_string();
            });
            update_state::<State>(|s| {
                s.game_status = "Period2".to_string();
            });
        } else {
            println!("{}", "[CheckGameStatus] Check if normal time is complete");
            let _cse_temp_4 = state.time_elapsed >= GAME_LENGTH_IN_SECONDS;
            if _cse_temp_4 {
                ...
                if _cse_temp_5 {
                    ...
                    update_state::<State>(|s| {
                        s.game_status = "ExtraTime".to_string();
                    });
                    update_state::<State>(|s| {
                        s.period.name = "ExtraTime".to_string();
                    });
                    update_state::<State>(|s| {
                        s.period.number = 3;
                    });
    ...
    if _cse_temp_6 {
        ...
        let _cse_temp_7 = state.time_elapsed >= GAME_LENGTH_IN_SECONDS + EXTRA_TIME_LENGTH_IN_SECONDS;
...
#[doc = " Depyler: proven to terminate"]
pub fn clock(state: &State) -> ClockOutputs {
    ...
    let model: ClockInferOutputs0 = infer::<ClockInferOutputs0>(
        "clock".to_string(),
        vec![
            btf(state.current_play_type.clone() == "Pass"),
            btf(state.current_play_type.clone() == "RunTackle"),
            btf(state.current_play_type.clone() == "KickTurnover"),
            btf(state.current_play_type.clone() == "ErrorAttack"),
            btf(state.current_play_type.clone() == "ErrorDefence"),
            btf(state.current_play_type.clone() == "RunTry"),
            btf(state.current_play_type.clone() == "ConcededPenalty"),
            btf(state.current_play_type.clone() == "WonPenalty"),
    ...
    update_state::<State>(|s| {
        s.time_elapsed = state.time_elapsed + (seconds_to_add) as i32;
    });
    println!("{}", "[Clock] Log");
    println!(
        "{}",
        format!(
            "current_play_type: {}, seconds_to_add: {}, seconds_to_add_initial: {}, adjustment: {}, elapsed: {}.",
            state.current_play_type.clone(),
            seconds_to_add,
...
pub fn conversion(state: &mut State) {
    ...
    swap_possession(state);
    println!("{}", "[Conversion] Process kickoff with force possession change");
    kickoff(&state, true, false);
    return;
}
#[doc = " Depyler: proven to terminate"]
pub fn end_zone(state: &State) {
    ...
    grid_coordinate = derive_grid_coordinate(&state.ball_location.clone(), state.team_in_possession.clone());
    println!("{}", "[EndZone] Calculate end zone classification from grid coordinate");
...
pub fn field_goal(state: &mut State) {
    ...
    if field_goal_result.scored {
        ...
        if _cse_temp_0 {
            ...
            println!("{}", "[FieldGoal] Set variables");
            let _cse_temp_1 = PLAYING_FIELD_WIDTH - state.ball_location.x;
    ...
    if !field_goal_result.scored {
        ...
        if _cse_temp_3 {
            println!("{}", "[FieldGoal] Set variables");
            update_state::<State>(|s| {
                s.ball_location.x = MISSED_FIELD_GOAL_RESTART_X;
            });
            update_state::<State>(|s| {
                s.ball_location.y = CENTRE_OF_THE_FIELD_Y;
            });
        } else {
            println!("{}", "[FieldGoal] Set variables");
            update_state::<State>(|s| {
            ...
            update_state::<State>(|s| {
                s.ball_location.x = PLAYING_FIELD_WIDTH - MISSED_FIELD_GOAL_RESTART_X;
            });
        }
    }
    return;
...
pub fn field_goal_attempt(state: &State) -> FieldGoalAttemptOutputs {
    ...
    let model: FieldGoalAttemptInferOutputs0 = infer::<FieldGoalAttemptInferOutputs0>(
        ...
        vec![
            ...
            (if (calculate_margin(state)).abs() < 2 { 1.0 } else { 0.0 }) as f64,
            (if calculate_margin(state) > 10 { 1.0 } else { 0.0 }) as f64,
...
pub fn get_conversion_model_result(state: &State) -> GetConversionModelResultOutputs {
    ...
    let _cse_temp_1 = (if state.team_in_possession.clone() == "Home" {
        (state.away_sin_bin.clone().len() as i32).saturating_sub(state.home_sin_bin.clone().len() as i32)
    } else {
        (state.home_sin_bin.clone().len() as i32).saturating_sub(state.away_sin_bin.clone().len() as i32)
    }) as i32;
    ...
    let xy_model: GetConversionModelResultInferOutputs0 = infer::<GetConversionModelResultInferOutputs0>(
        "xy".to_string(),
        vec![
            (state.tackles) as f64,
            (if state.team_in_possession.clone() == "Home" {
            ...
            btf((["Run", "RunTackle"].contains(&state.current_play_type.as_str()))
                || ((state.current_play_type.clone() == "RunTry") && (!is_extra_time))),
            btf(
                (["KickRetain", "KickRetainTackle", "KickTurnover"].contains(&state.current_play_type.as_str()))
    ...
    let conversion_model: GetConversionModelResultInferOutputs1 = infer::<GetConversionModelResultInferOutputs1>(
    ...
    return GetConversionModelResultOutputs::new(sample(&conversion_model.probabilities, conversion_k) == 1);
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_field_goal_model_result(state: &State) -> GetFieldGoalModelResultOutputs {
    ...
    return GetFieldGoalModelResultOutputs::new(sample(&model.probabilities, rand::random::<f64>()) == 1);
}
#[doc = " Depyler: proven to terminate"]
pub fn get_kickoff_model_result(state: &State) -> GetKickoffModelResultOutputs {
    ...
    let model: GetKickoffModelResultInferOutputs0 = infer::<GetKickoffModelResultInferOutputs0>(
        "kickoff".to_string(),
        vec![
            btf(state.team_in_possession.clone() == "Home"),
            (state.time_elapsed) as f64,
            0.0,
            (if state.team_in_possession.clone() == "Home" {
                (state.home_players.clone().len() as i32).saturating_sub(state.away_players.clone().len() as i32)
            } else {
                (state.away_players.clone().len() as i32).saturating_sub(state.home_players.clone().len() as i32)
            }) as f64,
            btf(state.current_play_type.clone() == "LineDropout"),
        ],
    );
    ...
    return GetKickoffModelResultOutputs::new(
        !KICKOFF_RETAIN_RESULTS.clone().contains(&kickoff_result.clone()),
        KICKOFF_TO_GRID_RESULT.clone().get(&kickoff_result).cloned().unwrap(),
    );
}
#[doc = " Depyler: proven to terminate"]
pub fn interchange(state: &mut State) {
    ...
    if _cse_temp_0 {
        ...
        let home_interchange_model: InterchangeInferOutputs0 = infer::<InterchangeInferOutputs0>(
            ...
            vec![
                ...
                (get_time_on_field_for_position(&state, "Home".to_string(), "FullBack".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "WingerOne".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "CentreOne".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "CentreTwo".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "WingerTwo".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "FiveEighth".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "HalfBack".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "PropOne".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "Hooker".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "PropTwo".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "SecondRowOne".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "SecondRowTwo".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Home".to_string(), "Lock".to_string())) as f64,
                (get_interchanges_used(&state, "Home".to_string())) as f64,
            ],
        );
        println!("{}", "[Interchange] Decide home interchange outcome");
        let _cse_temp_1 = (home_interchange_model.probabilities.get(0usize).cloned().unwrap()) as i32;
    ...
    if home_should_interchange {
        ...
        let home_execution: PlayerInterchangeOutputs = player_interchange(&state, "Home".to_string());
    ...
    if _cse_temp_0 {
        ...
        let away_interchange_model: InterchangeInferOutputs1 = infer::<InterchangeInferOutputs1>(
            ...
            vec![
                ((state.clone().time_elapsed / 60) as i32) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "FullBack".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "WingerOne".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "CentreOne".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "CentreTwo".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "WingerTwo".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "FiveEighth".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "HalfBack".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "PropOne".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "Hooker".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "PropTwo".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "SecondRowOne".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "SecondRowTwo".to_string())) as f64,
                (get_time_on_field_for_position(&state, "Away".to_string(), "Lock".to_string())) as f64,
                (get_interchanges_used(&state, "Away".to_string())) as f64,
            ],
        );
        println!("{}", "[Interchange] Decide away interchange outcome");
        let _cse_temp_3 = (away_interchange_model.probabilities.get(0usize).cloned().unwrap()) as i32;
    ...
    if away_should_interchange {
        ...
        let away_execution: PlayerInterchangeOutputs = player_interchange(&state, "Away".to_string());
...
#[doc = " Depyler: verified panic-free"]
pub fn kickoff(state: &State, force_possession_change: bool, is_line_dropout: bool) {
    ...
    if _cse_temp_0 {
        ...
        if _cse_temp_1 {
            ...
            update_state::<State>(|s| {
                s.team_in_possession = "Away".to_string();
            });
        } else {
            println!("{}", "[Kickoff] Set variables");
            update_state::<State>(|s| {
                s.team_in_possession = "Home".to_string();
            });
        }
    }
    ...
    while true {
        println!("{}", "[Kickoff] Reset new team to current possession");
        new_team_in_possession = state.clone().team_in_possession.clone();
        ...
        if !is_line_dropout {
            ...
            if new_team_in_possession.clone() == "Home".to_string() {
                println!("{}", "[Kickoff] Set variables");
                field_position = convert_field_position(state, kickoff.grid_result.clone(), "Away".to_string());
            } else {
                println!("{}", "[Kickoff] Set variables");
                field_position = convert_field_position(state, kickoff.grid_result.clone(), "Home".to_string());
            }
        } else {
            println!("{}", "[Kickoff] Set variables");
            field_position = convert_field_position(state, kickoff.grid_result.clone(), new_team_in_possession.clone());
        }
    ...
    update_state::<State>(|s| {
        s.ball_location = field_position.clone();
    });
    update_state::<State>(|s| {
        s.team_in_possession = new_team_in_possession.clone();
    });
    return;
}
#[doc = " Depyler: verified panic-free"]
...
pub fn player_interchange(state: &State, team: String) -> PlayerInterchangeOutputs {
    ...
    let model: PlayerInterchangeInferOutputs0 = infer::<PlayerInterchangeInferOutputs0>(
        ...
        vec![
            ...
            (get_time_on_field_for_position(state, team.clone().to_string(), "FullBack".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "WingerOne".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "CentreOne".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "CentreTwo".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "WingerTwo".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "FiveEighth".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "HalfBack".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "PropOne".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "Hooker".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "PropTwo".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "SecondRowOne".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "SecondRowTwo".to_string())) as f64,
            (get_time_on_field_for_position(state, team.clone().to_string(), "Lock".to_string())) as f64,
            (state.set) as f64,
...
pub fn player_meters(state: &State) -> PlayerMetersOutputs {
    ...
    let model: PlayerMetersInferOutputs0 = infer::<PlayerMetersInferOutputs0>("player_meters".to_string(), vec![]);
    println!("{}", "[PlayerMeters] Return sampled player");
    return PlayerMetersOutputs::new(sample(&model.probabilities, rand::random::<f64>()));
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn player_of_the_match(state: &State, enabled: bool) -> PlayerOfTheMatchOutputs {
    ...
    println!("{}", "[PlayerOfTheMatch] Skip processing when feature disabled");
    if !enabled {
        println!("{}", "[PlayerOfTheMatch] Return");
        return PlayerOfTheMatchOutputs::new(state.player_of_the_match);
    }
    println!("{}", "[PlayerOfTheMatch] Calculate player of the match distributions");
    ...
    if _cse_temp_2 {
        ...
        sample_index = sample_scaled(&player_distributions, distribution_sum, rand::random::<f64>());
    } else {
        println!("{}", "[PlayerOfTheMatch] Set variables");
    ...
    pom_player_index = state
        ...
        .unwrap()
        .player_index;
    println!("{}", "[PlayerOfTheMatch] Persist player of the match on state");
    update_state::<State>(|s| {
        s.player_of_the_match = pom_player_index;
    });
    println!("{}", "[PlayerOfTheMatch] Return");
...
pub fn player_sin_bin(state: &State, sin_bin_team_is_home: bool) {
    ...
    println!("{}", "[PlayerSinBin] Update state markers for sin bin event");
    if _cse_temp_0 {
...
pub fn process_penalty(state: &mut State) {
    ...
    if _cse_temp_1 {
        println!("{}", "[ProcessPenalty] Run conversion model for penalty shot");
        let conversion_result: GetConversionModelResultOutputs = get_conversion_model_result(&state);
...
pub fn process_sin_bin_check(state: &State) {
    ...
    if send_off_result.sent_off {
        player_sin_bin(
            state,
            ((state.current_play_type.clone() == "WonPenalty") && (state.team_in_possession.clone() == "Home"))
                || ((state.current_play_type.clone() != "WonPenalty") && (state.team_in_possession.clone() == "Away")),
        );
    }
    return;
}
...
pub fn process_tackle(state: &mut State) {
    ...
    update_state::<State>(|s| {
        s.tackles = state.tackles + 1;
    });
    println!("{}", "[ProcessTackle] Check if tackle limit exceeded");
    let _cse_temp_0 = state.tackles > TACKLES_PER_SET;
    if _cse_temp_0 {
        swap_possession(state);
    }
    return;
...
pub fn process_try(state: &mut State) {
    ...
    add_try(state);
    println!("{}", "[ProcessTry] Player try assignment if players enabled");
    if state.include_players {
        println!("{}", "[ProcessTry] Get player tries model result");
        let try_selection: PlayerTriesOutputs = player_tries(&state, state.team_in_possession.clone().clone());
        println!("{}", "[ProcessTry] Assign try to selected player");
        assign_try(state, try_selection.player_index, try_selection.team.clone());
    }
...
#[doc = "Register all event functions using the global register_event function."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn register_events() {
    register_event_with_when("debug".to_string(), |state| state.is_over, debug);
    register_event_with_when("anytime_output_event".to_string(), |state| false, anytime_output_event);
    register_event_with_when(
        "end_of_game_output_event".to_string(),
        |state| state.game_status.clone() == "ENDED",
        end_of_game_output_event,
    );
    register_event_with_when(
        "first_half_output_event".to_string(),
        |state| false,
        first_half_output_event,
    );
    register_event_with_when(
        "normal_time_output_event".to_string(),
        |state| false,
        normal_time_output_event,
    );
    register_event_with_when(
        "player_void_output_event".to_string(),
        |state| true,
        player_void_output_event,
    );
    register_event_with_when(
        "period_first_last_score_helper".to_string(),
        |state| false,
        period_first_last_score_helper,
    );
    register_event_with_when(
        "first_to_score_tracking_event".to_string(),
        |state| (state.incidents.clone().len() as i32 > 0) || (state.is_over),
        first_to_score_tracking_event,
    );
    register_event_with_when(
        "minute_winner_tracking_event".to_string(),
        |state| (state.incidents.clone().len() as i32 > 0) || (state.is_over),
        minute_winner_tracking_event,
    );
    register_event_with_when(
        "player_score_tracking_event".to_string(),
        |state| state.incidents.clone().len() as i32 > 0,
        player_score_tracking_event,
    );
    register_event_with_when(
        "race_to_points_tracking_event".to_string(),
        |state| (state.incidents.clone().len() as i32 > 0) || (state.is_over),
        race_to_points_tracking_event,
    );
}
#[cfg(test)]
mod tests {
